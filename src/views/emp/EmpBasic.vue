        ...
        <div>
            <div style="display: flex;justify-content: space-between;">
                ...
                <div style="margin-top: 10px;">
                    ...
                    <el-button type="primary" @click="showAdvanceSearch">
                ...
                <div>
                    ...
                    <el-button type="success" @click="exportData"><i class="el-icon-download" aria-hidden="true"></i>&nbsp;
                        导出数据
                    </el-button>
                ...
                <div v-show="showAdvanceSearchVisible"
                 ...
                 font-size: 12px;padding-left: 8px;box-sizing: border-box;"
                        ...
                        <el-col :span="5" :offset="4">
                            ...
                            <el-button type="primary" icon="el-icon-search" size="mini" @click="initEmps('advanced')">
                                搜索
                            </el-button>
                        </el-col>
                    </el-row>
